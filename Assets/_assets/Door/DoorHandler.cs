...
public class DoorHandler : MonoBehaviour {
	...
	void Update () {
        if( transform.localRotation != Quaternion.AngleAxis(_angleAxis, Vector3.up))
        {
            transform.localRotation = Quaternion.RotateTowards(transform.rotation, Quaternion.AngleAxis(_angleAxis, Vector3.up), _step);
